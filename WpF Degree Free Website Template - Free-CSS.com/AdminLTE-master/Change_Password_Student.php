...
<head>
  ...
  <link rel="stylesheet" href="dist/dist/fastselect.min.css">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="StudentDashboard.php"><i class="fa fa-circle-o"></i> Request For Tution</a></li>
           </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="Change_Password_Student.php"><i class="fa fa-user-circle-o"></i> CHANGE PASSWORD</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
...
<script src="dist/dist/fastselect.standalone.js"></script>
